 ...
 public Person(String first, String family, String ID, int birth) {
	 ...
	 */
	 ...
	 public int age(int year) {
		...
		@Override
		public int hashCode() {
			return Objects.hash(IDNumber, birthYear, familyName, givenName);
		}
		...
		public boolean equals(Object obj) {
			...
			return Objects.equals(IDNumber, other.IDNumber) && birthYear == other.birthYear
					&& Objects.equals(familyName, other.familyName) && Objects.equals(givenName, other.givenName);
		}
		}